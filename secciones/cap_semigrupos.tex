...
\begin{proof}
    ...
    \begin{align*}
        ...
        \text{(Teorema \ref{ch:semigrupos:th:cotaExp})}&\leq \frac{M ||e||_{E_0} \int_0^\infty \mathrm{e}^{-(\operatorname{Re}(\lambda) - \beta)t} \, dt}{||e||_{E_0}}\\
...
\begin{proof}
    ...
    Ahora, como $R(\lambda_0 - A) = E_0$, entonces $(\lambda_0 - A)$ es sobreyectivo. Por otro lado, como $\lVert (\lambda_0 - A)e \lVert_{E_0} \geq \lambda_0 \lVert e \lVert_{E_0}$, se tiene que, si definimos $y := (\lambda_0 -A)e \in E_0$, entonces:
